...
/**
 * Normalizes a role string to a standard role.
 * Specifically handles 'student' -> 'passenger'.
 ...
 * @param {string|string[]} allowedRoles - The role or array of roles allowed to access the route.
 * @returns {function(import('express').Request, import('express').Response, import('express').NextFunction): Promise<void>} The middleware function.
 */
